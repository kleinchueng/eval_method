    ...
    for i in range(MAX_API_RETRY):
        try:
            response = openai.ChatCompletion.create(
                ...
                temperature=0.7,  # TODO: figure out which temperature is best for evaluation
...
if __name__ == '__main__':
    ...
    parser.add_argument('-q', '--question-file', type=str,
                        default="question.jsonl")
    parser.add_argument('-a', '--answer-file-list', nargs='+', default=["vicuna_output.jsonl", "chatglm_output.jsonl"])
    parser.add_argument('-p', '--prompt-file', type=str, default="prompt.jsonl")
    parser.add_argument('-r', '--reviewer-file', type=str, default="reviewer.jsonl")
    parser.add_argument('-o', '--output-review-file', type=str, default="review-output.jsonl")
